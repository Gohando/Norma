...
class MainViewModel @Inject constructor(
    ...
    private val runsSortedByCaloriersBurned = mainRepository.getAllRunsSortedByCaloriesBurned()
    ...
    init {
        ...
        runs.addSource(runsSortedByCaloriersBurned) { result ->
    ...
    fun sortRuns(sortType: SortType) = when(sortType) {
        ...
        SortType.CALORIES_BURNED -> runsSortedByCaloriersBurned.value?.let { runs.value = it }
    }.also {
